<div>
    ...
    <!-- Modal body -->
    <form wire:submit.prevent='login_form'>
        @error('noLogin')
        ...
        @error('Login')
            <div class="grid grid-cols-1 gap-1 text-center">
                <div class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-green-50 text-center" role="alert">
                    {{ $message }}
                </div>
            </div>
        @enderror
        ...
        <div class="grid grid-cols-3 gap-2 mx-6 my-4">
            <div>
                <button type="button" wire:click="irRegiter"
                    class="font-medium text-blue-600  hover:underline">Registrame</a>
            </div>
            <div class="col-start-3 text-end">
                <button type="button" wire:click="irForget" class="font-medium text-blue-600  hover:underline">Olvide
                    contraseña</a>
            </div>
        </div>
        <!-- Modal footer -->
            ...
            <div class="grid grid-cols-2 gap-2 mx-4">
                <div>
                    <button type="submit"
                        ...
                        style="background-color:#7F1D80">Iniciar
                        sesión</button>
                </div>
